...
* URS
***************************************************************
PARAMETERS cBill_ID, cProv_ID, cProv2_ID, lReprocess
...
CREATE CURSOR printdata ;
	(magnetic C(3), cur_year C(2), jul_day N(3,0), prov_id C(5), prov_num C(12), ;
...
cOutputStr = cOutputStr + Rtrim(cSub_ID) + '*'					&& GS02 -- Application Sender Code            
...
cOutputStr = cOutputStr + Rtrim(cSub_ID)							&& NM109 -- ID code
...
ELSE 
		cOutputStr = cOutputStr + CCYYMMDD(claim_cur.date)	 + '-' + ;
					CCYYMMDD(claim_cur.date)													&& DTP03 Service Date
ENDIF
