...
? 'Build EXE, Copy to c:\AIRS\urs.exe, Copy to production folder ..\urs.exe'
? 'Packing Libs...'
? "--------------------------------------------------"
...
Try
  ? 'Copy to c:\airs\...'
  Copy File urs.exe To c:\airs\urs.exe
  ? '*** Copied to c:\airs ***'
Catch
  ? '!!!! c:\airs\urs.exe is in use, copy manually'
EndTry 

Try
  ? 'Copy to c:\airsCL\...'
  Copy File urs.exe To c:\airsCL\urs.exe
  ? '*** Copied to c:\airsCL ***'
Catch
  ? '!!!! c:\airs\urs.exe is in use, copy manually'
EndTry
...
*!*   Try
*!*     ? 'Copy to c:\airs\...'
*!*     Copy File urs.exe To C:\AIRSAgency\urs.exe
*!*     ? '*** Copied to C:\AIRSAgency\airs ***'
*!*   Catch
*!*     ? '!!!! C:\AIRSAgency\urs.exe is in use, copy manually'
*!*   EndTry 
