...
If InList(lnStat, 1, 2) 
   Select ;
      ...
      ICase(client.gender='10','10',;
            client.gender='11','11', ;
            InList(client.gender,'12','13','15','16'),'12',;
            InList(client.gender,'14','17','18','19'),'14',;
            '14') As gender,;
      ICase(client.gender='10','Woman/Girl ',;
            client.gender='11','Man/Boy    ', ;
            InList(client.gender,'12','13','15','16'),'Transgender',;
            InList(client.gender,'14','17','18','19'),'Unknown    ',;
   ...
   FROM ;
      ...
      Client;
   WHERE ;
      Between(Needlx.Date, from_d, To_d) AND ;
      Needlx.tc_id=Ai_Clien.Tc_Id  AND ;
      Ai_Clien.Client_id=Client.Client_Id  AND ;
      Needlx.Program=lcprogx And (client.hispanic = 2 or client.hispanic = 1 or client.hispanic = 0) ;
      &cFiltExpr ;   
    INTO CURSOR  temp 
   ...
   * Unknown
   ...
   WHERE ;
      ...
      Ai_Clien.Client_id = Client.Client_Id AND ;
      Needlx.Program = lcprogx And ;
      (client.white+client.blafrican+client.asian+client.hawaisland+client.indialaska+client.unknowrep+client.someother=(0) Or ;
      (client.unknowrep=(1) And client.white + client.blafrican + client.asian + client.hawaisland + client.indialaska + client.someother = 0)) ;      
      &cFiltExpr ;   
   INTO CURSOR ;
      Race6 
