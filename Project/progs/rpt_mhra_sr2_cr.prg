...
Select f.*, oApp.gcversion as version, DTOC(oApp.gdverdate) as verdate ;
   FROM final as f ;
   INTO CURSOR tmp
...
Else
COPY TO CrRptpath+"cdc_service_rollup.dbf"
...
LcAction = "open" 
Lcparms = "cdc_service_rollup.rpt"
