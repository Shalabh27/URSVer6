...
From ai_ref ;
 ...
 Where  between(ai_ref.ref_dt, Date_from,Date_to) ;
       &cWhere ;
 Union ;  
 Select Distinct ;
        ai_ref.tc_id, ;
...
From ai_ref ;
 ...
 into cursor ;        
  ...
  SELECT *, gcagencyname as agencyname, oApp.gcversion as version, ;
