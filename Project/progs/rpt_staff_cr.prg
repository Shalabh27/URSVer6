...
Select r.*, gcagencyname as ageencyname FROM roster as r INTO CURSOR temp
GO TOP
IF EOF()
   oApp.msg2user('NOTFOUNDG')
ELSE
      COPY TO CrRptpath+"roster.dbf"
...
LcAction = "open" 
Lcparms = "staff_alpha_list.rpt"
Lcdir = "i:\ursver6\airs_crreports\"
nsuccess = ShellExecute(0,LcAction,Lcfilename,lcparms,lcdir,1)
